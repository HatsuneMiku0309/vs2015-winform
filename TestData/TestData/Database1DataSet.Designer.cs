...
namespace TestData {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class studentDataTable : global::System.Data.TypedTableBase<studentRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0")]
            public studentRow AddstudentRow(string name, string number) {
...
namespace TestData.Database1DataSetTableAdapters {
    ...
    public partial class studentTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [student] WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [na" +
                "me] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_number = 1 AND [number]" +
                " IS NULL) OR ([number] = @Original_number)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [student] ([name], [number]) VALUES (@name, @number);\r\nSELECT Id, nam" +
                "e, number FROM student WHERE (Id = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [student] SET [name] = @name, [number] = @number WHERE (([Id] = @Original_Id) AND ((@IsNull_name = 1 AND [name] IS NULL) OR ([name] = @Original_name)) AND ((@IsNull_number = 1 AND [number] IS NULL) OR ([number] = @Original_number)));
SELECT Id, name, number FROM student WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::TestData.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT          Id, name, number\r\nFROM              student";
        ...
        public virtual int Update(string name, string number, int Original_Id, string Original_name, string Original_number, int Id) {
            if ((name == null)) {
